  ...
  return (
    <div className="min-h-screen grid place-items-center p-6">
      <form onSubmit={submit} className="w-full max-w-md space-y-3 rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <input value={name} onChange={e=>setName(e.target.value)} placeholder="الاسم الكامل" className="px-4 py-3 rounded-xl bg-black/30 border border-white/10 w-full" required />
        ...
        <div className="text-sm flex justify-between">
          <Link to="/login" className="underline">لديك حساب؟ دخول</Link>
